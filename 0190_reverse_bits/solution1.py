...
#   the right-most bit of an integer, we apply the bit AND operation (n & 1).
# - For each bit, we reverse it to the correct position (i.e. (n & 1) << power). Then we accumulate this 
#   reversed bit to the final result.
